package com.pax.paxwidthheightautosize.px;
...
public class DimenPXThread implements Runnable{
    ...
    static{
        dimensData.add(new DimensPX(480,782));
...
//        dimensData.add(new DimensPX(720,1440));
//        dimensData.add(new DimensPX(720,1480));
//        dimensData.add(new DimensPX(768,1280));
//        dimensData.add(new DimensPX(800,1208));
...
//            String parentName = path + "values-"+dimensPX.getyPX() + "x" + dimensPX.getxPX();
            String parentName = path + "values-"+dimensPX.getxPX() + "x" + dimensPX.getyPX();
